...
export default function InputFieldBudget(props) {
    return (
        <fieldset className="border-2 border-gray-100 rounded-md p-3 m-5">
            ...
            <div className="flex flex-auto mt-5 focus-within:font-bold">
                ...
                <input type="number" name="price" className="ml-9 px-3 border-2 border-gray-300 rounded-md" required />
            </div>
